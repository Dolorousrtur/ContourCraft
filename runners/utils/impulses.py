...
class CollisionSolver:
    ...
    def compute_impulses_with_interpolation(self, triangles1, triangles2, triangles_mass):
        ...
        for i in range(self.mcfg.n_ccoll_interpolation):
            ...
            bboxes, tree = cccollisions.bvh_motion(tri_from, tri_to)
            cont_collisions, roots = cccollisions.find_collisions_continuous(bboxes, tree, tri_from, tri_to, 64,
                                                                                 16)
        ...
        imp_dv, imp_dx, imp_counter = cccollisions.compute_impulses_from_collisions(collisions_list, roots_list,
                                                                                        triangles1,
...
def safecheck_impulses_pp(faces, verts0, verts1, velocity, mass, penetrating_mask, vertex_type, pinned_mass=1000,
    ...
    for i in range(n_impulse_iters):
        ...
        bboxes, tree = cccollisions.bvh_motion(triangles1, triangles2)
        cont_collisions, roots = cccollisions.find_collisions_continuous(bboxes, tree, triangles1, triangles2,
                                                                             64 * 4,
                                                                             16)
        ...
        imp_dv, imp_dx, imp_counter = cccollisions.compute_impulses_from_collisions(cont_collisions, roots,
                                                                                        triangles1,
                                                                                        triangles2, triangles_mass)
...
def safecheck_impulses_partial(faces, verts0, verts1, velocity, mass,
    ...
    for i in range(n_impulse_iters):
        ...
        if faces_to_check is None:
            ...
            imp_dv, imp_dx, imp_counter = cccollisions.compute_impulses_partial(bboxes, tree, triangles1, triangles2,
                                                                            triangles_mass, faces_to_check,
                                                                            32 * 3, 16)

        # out_collisions, roots = cccollisions.find_collisions_continuous(bboxes, tree, triangles1, triangles2,
        #                                                                     32, 16)
        ...
        #     out_collisions, roots = cccollisions.find_collisions_continuous_partial(bboxes, tree, triangles1, triangles2,
