...
class Untangler:
    def __init__(self, checkpoint_path, n_epochs=2, n_steps_per_epoch=30, gender='female', use_uv=False):
    ...
    def untangle_single(self, untanglement, inner_garments, new_garment):
        ...
        pickle_dump(combined_trajectory_dict, out_path)
    ...
    def untangle_all(self, garment_list):
        ...
        sample = self.simulator._create_zeropos_sample(garment_name_comma, 
                                                       self.n_steps_per_epoch, gender=self.gender)
...
class Untanglement:
    ...
    def _combine_trajectories(self, trajectory_dict_list):
        ...
        combined_trajectory_dict['obstacle_faces'] = trajectory_dict_list[0]['obstacle_faces']
